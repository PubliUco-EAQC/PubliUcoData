...
public class HistorialAccesoPublicacionPosgreSqlDAO implements HistorialAccesoPublicacionDAO {

	public HistorialAccesoPublicacionPosgreSqlDAO(final Connection connection) {
